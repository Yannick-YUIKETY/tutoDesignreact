    ...
    <View style={{
      ...
      <ScrollView  style={{
        ...
        <View style={{
          ...
          <Text style={{marginLeft:Spacing, color:Colors.gray, fontFamily:Font["poppins-regular"]}} > {product.rating} </Text>
          <Text style={{marginLeft:Spacing, color:Colors.gray, fontFamily:Font["poppins-regular"]}} > {product.reviews} Review </Text>
        </View>
